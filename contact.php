...
<div id = "body" class = "sixteen columns"  >
        ...
        <h2> Contact Andrew Dunkerley </h2>
        <p> Complete the form below to Get in touch with Andrew</p>
        ...
        <div id= "contact" class = "container" class = "sixteen columns" >
        ...
        <div id = "contactformdiv" class= "ten columns offset-by-six">
