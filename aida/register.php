...
?>
  ...
  -moz-border-radius: 16px;
                        ...
                        <div id="flip"  >Show/Hide Registation Form</div>
                     ...
                     <script>
                             $("#username").keyup(function (e) { //user types username on inputfiled
                                 var username = $(this).val(); //get the string typed by user
                                  $.post('checkusername.php', {'username':username}, function(data) { //make ajax call to checkusername.php
                    ...
                    <?php echo " Please enter the numbers above in the box below.";
                    ?>
                    <label for="capcha">Captcha:</label>
					<input type="text" size="6" maxlength="5" name="capcha" />
					...
					}else if($_POST['capcha'] != $_SESSION['digit']) {
        
        
                    echo "Sorry, the CAPTCHA code entered was incorrect!";
